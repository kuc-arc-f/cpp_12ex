...
C++ Window Webview2 + RAG Search + React
...
https://github.com/kuc-arc-f/cpp_12ex/tree/main/rag_15sql
...
clang++ -target x86_64-pc-windows-msvc -m64 -std=c++17 -O2 main.cpp -o main.exe ^
  ...
  -L./lib ^
  -lWebView2Loader.dll -luser32 -lgdi32 -lole32 -loleaut32 -llibcurl -lsqlite3 -lcpr
